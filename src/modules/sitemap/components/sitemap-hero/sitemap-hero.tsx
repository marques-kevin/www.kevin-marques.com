  ...
  return (
    <div className={classNames("relative")}>
      ...
      <div className="flex flex-col items-center justify-center text-center">
        <div className="mx-auto block max-w-6xl flex-col text-4xl font-semibold leading-none tracking-tighter text-slate-900 sm:text-4xl md:text-5xl lg:text-6xl">
          <ReactMarkdown
            components={{
              p: ({ children }) => <>{children}</>,
              em: ({ children }) => (
              ...
              strong: ({ children }) => (
                <span className="underline decoration-pink-200 underline-offset-4">
                  {children}
                </span>
              ),
            }}
